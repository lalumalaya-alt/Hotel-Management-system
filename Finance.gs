...
function askAIAssistant(question, username, role, chatHistory) {
  try {
    ...
    if (!GEMINI_API_KEY) {
      return { success: false, message: "AI Assistant is not configured. Please contact the administrator." };
    }
...
function setupDemoData() {
  ...
  settingsSheet.appendRow(["Hill View Eco Retreat", "Demo Location, Maldives", "+960-0000000", "info@demo.com", "", "", "", "MVR", 5, 6, 5, 6, "", "", 4, 1]);
