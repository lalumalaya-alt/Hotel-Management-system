...
// I just noticed the getSettings check in addExtraPersonToRestaurant isn't using a fixed value
// and the check-in might not find the right columns for Restaurant. Let's make sure it perfectly matches the app's structure.
...
// remove the previously injected ones and put the new ones
code = code.replace(/function addExtraPersonToRestaurant[\s\S]*?function shiftRooms[\s\S]*?\n}\n/m, fix);
